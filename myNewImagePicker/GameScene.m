...
float myPhotoSpriteScale = .2;
int myCircleSpriteSize = 10;
int myShape = 0;
float myCircleSpriteScale = 0.1;
float myColorSpriteRestitution = 0.95;
...
-(void)didMoveToView:(SKView *)view {
    ...
    //    UIImage *myButton1Image = [UIImage imageNamed:@"Stars.png"];
    //    UIImage *myButton2Image = [UIImage imageNamed:@"Paper.png"];
    //    UIImage *myButton3Image = [UIImage imageNamed:@"Marbles.png"];
    //    NSArray *myControlValues  = [[ NSArray alloc] initWithObjects:myButton1Image, myButton2Image, myButton3Image, nil] ;
    ...
    //    [myControl setTitle:nil forSegmentAtIndex:0];
    //    [myControl setImage:myButton1Image forSegmentAtIndex:0];
